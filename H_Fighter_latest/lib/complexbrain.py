...
class ComplexBrain(object):
    def __init__(self, n_inputs, n_hidden, n_outputs):
        ...
        # unit_1 = ComputationUnit([(CLUSTER_INPUT       , self.n_inputs)],
        #                          (CLUSTER_INTERMEDIATE, self.n_hidden))
        # unit_2 = ComputationUnit([(CLUSTER_INTERMEDIATE, self.n_hidden)],
        #                          (CLUSTER_OUTPUT      , self.n_outputs))
