...
class Physical(object):
    ...
    def __init__(self, room):
        ...
        self.vxy = matrix([[0., 0.]])
        # If not equal to zero, this stores the normal of the side you've been
        # pushed out of...
        self.grounded = 0
        self.room = room
        self.randomize_position()
        # Think of as time remaining to process information since it changes
    ...
    def update(self, dt, key_states, key_presses):
        ...
        self.objectsinview = self.room.object_directory[
            x % graphics.world_tw][y % graphics.world_th]
        for c, r in self.tiles_that_cover_me():
            self.room.object_directory[c % graphics.world_tw][
                r % graphics.world_th].append(self)
